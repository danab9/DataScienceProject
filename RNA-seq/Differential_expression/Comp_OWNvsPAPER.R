...
# description:  Venn diagramm of upregulated results paper and own (results of differential gene expression analysis).
...
ggplot() +
  ...
  theme_void()
dev.off()
# description:  Venn diagramm of downregulated results paper and own (results of differential gene expression analysis).
