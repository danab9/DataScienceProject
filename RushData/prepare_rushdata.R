...
filenames<- read.table("/home/rosa/rush_data/helpers/filenames.txt")
...
write_csv(reduced_report, "/home/rosa/rush_data/overview.tsv")



dir<- "/home/rosa/rush_data"
overview<- read.csv("/home/rosa/rush_data/helpers/overview.csv", header=TRUE)
...
refseq_genesym<- read.csv("/home/rosa/rush_data/refseq_genesymbol.tsv", header=FALSE)
...
write.csv(file="/home/rosa/rush_data/all_counts.csv", merged)
